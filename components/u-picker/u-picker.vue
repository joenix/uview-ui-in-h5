<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
		<div class="u-datetime-picker">
			<div class="u-picker-header" @touchmove.stop.prevent="">
				<div class="u-btn-picker u-btn-picker--tips" 
					:style="{ color: cancelColor }" 
					hover-class="u-opacity" 
					:hover-stay-time="150" 
					@tap="getResult('cancel')"
				>{{cancelText}}</div>
				<div class="u-picker__title">{{ title }}</div>
				<div
			...
			<div class="u-picker-body">
				<picker-view v-if="mode == 'region'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
					<picker-view-column v-if="!reset && params.province">
						<div class="u-column-item" v-for="(item, index) in provinces" :key="index">
							<div class="u-line-1">{{ item.label }}</div>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.city">
						<div class="u-column-item" v-for="(item, index) in citys" :key="index">
							<div class="u-line-1">{{ item.label }}</div>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.area">
						<div class="u-column-item" v-for="(item, index) in areas" :key="index">
							<div class="u-line-1">{{ item.label }}</div>
						</div>
					</picker-view-column>
				</picker-view>
				<picker-view v-else-if="mode == 'time'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
					<picker-view-column v-if="!reset && params.year">
						<div class="u-column-item" v-for="(item, index) in years" :key="index">
							{{ item }}
							<span class="u-text" v-if="showTimeTag">年</span>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.month">
						<div class="u-column-item" v-for="(item, index) in months" :key="index">
							{{ formatNumber(item) }}
							<span class="u-text" v-if="showTimeTag">月</span>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.day">
						<div class="u-column-item" v-for="(item, index) in days" :key="index">
							{{ formatNumber(item) }}
							<span class="u-text" v-if="showTimeTag">日</span>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.hour">
						<div class="u-column-item" v-for="(item, index) in hours" :key="index">
							{{ formatNumber(item) }}
							<span class="u-text" v-if="showTimeTag">时</span>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.minute">
						<div class="u-column-item" v-for="(item, index) in minutes" :key="index">
							{{ formatNumber(item) }}
							<span class="u-text" v-if="showTimeTag">分</span>
						</div>
					</picker-view-column>
					<picker-view-column v-if="!reset && params.second">
						<div class="u-column-item" v-for="(item, index) in seconds" :key="index">
							{{ formatNumber(item) }}
							<span class="u-text" v-if="showTimeTag">秒</span>
						</div>
					</picker-view-column>
				</picker-view>
				<picker-view v-else-if="mode == 'selector'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
					<picker-view-column v-if="!reset">
						<div class="u-column-item" v-for="(item, index) in range" :key="index">
							<div class="u-line-1">{{ getItemValue(item, 'selector') }}</div>
						</div>
					</picker-view-column>
				</picker-view>
				<picker-view v-else-if="mode == 'multiSelector'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
					<picker-view-column v-if="!reset" v-for="(item, index) in range" :key="index">
						<div class="u-column-item" v-for="(item1, index1) in item" :key="index1">
							<div class="u-line-1">{{ getItemValue(item1, 'multiSelector') }}</div>
						</div>
					</picker-view-column>
				</picker-view>
			</div>
