...
<script>
	 ...
	 * @property {String Number} width 单元格宽度百分比或者具体带单位的值，如30%， 200px等，一般使用百分比，单元格宽度默认为均分tr的长度（默认auto）
	 * @example <u-td>二年级</u-td>
	 */
	export default {
		name: "u-td",
		props: {
			// 宽度，百分比或者具体带单位的值，如30%， 200px等，一般使用百分比
			width: {
				type: [Number, String],
				default: 'auto'
			}
