<template>
	<div class="">
		<div class="u-content" :class="[elId]" :style="{ 
			height: isLongContent && !showMore ? showHeight + 'px' : 'auto',
			textIndent: textIndent
		}">
			<slot></slot>
		</div>
		<div @tap="toggleReadMore" v-if="isLongContent" class="u-content__showmore-wrap"
		    :class="{ 'u-content__show-more': showMore }"
		    :style="[innerShadowStyle]">
			<span class="u-content__showmore-wrap__readmore-btn" :style="{
				fontSize: fontSize + 'px',
				color: color
			}">
				{{ showMore ? openText : closeText }}
			</span>
			<div class="u-content__showmore-wrap__readmore-btn__icon u-flex">
