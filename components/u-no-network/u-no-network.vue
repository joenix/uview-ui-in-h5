<template>
	<div class="u-no-network" v-if="!isConnected" :style="{'z-index': uZIndex}" @touchmove.stop.prevent="() => {}">
		<div class="u-inner">
			...
			<!-- #ifdef APP-PLUS -->
			<div class="u-to-setting">
				请检查网络，或前往<span class="u-setting-btn" @tap="openSettings">设置</span>
			</div>
			<!-- #endif -->
			<div class="u-retry" :hover-stay-time="150" @tap="retry" hover-class="u-retry-hover">
				重试
			</div>
		</div>
	</div>
