<template>
	<div class="u-form-item" :class="{'u-border-bottom': elBorderBottom, 'u-form-item__border-bottom--error': validateState === 'error' && showError('border-bottom')}">
		<div class="u-form-item__body" :style="{
			flexDirection: elLabelPosition == 'left' ? 'row' : 'column'
		}">
			<!-- 微信小程序中，将一个参数设置空字符串，结果会变成字符串"true" -->
			<div class="u-form-item--left" :style="{
				width: uLabelWidth,
				flex: `0 0 ${uLabelWidth}`,
				marginBottom: elLabelPosition == 'left' ? 0 : '10px',
			}">
				<!-- 为了块对齐 -->
				<div class="u-form-item--left__content" v-if="required || leftIcon || label">
					<!-- nvue不支持伪元素before -->
					<span v-if="required" class="u-form-item--left__content--required">*</span>
					<div class="u-form-item--left__content__icon" v-if="leftIcon">
						<u-icon :name="leftIcon" :custom-style="leftIconStyle"></u-icon>
					</div>
					<div class="u-form-item--left__content__label" :style="[elLabelStyle, {
			...
			<div class="u-form-item--right u-flex">
				<div class="u-form-item--right__content">
					<div class="u-form-item--right__content__slot ">
						<slot />
					</div>
					<div class="u-form-item--right__content__icon u-flex" v-if="$slots.right || rightIcon">
		...
		<div class="u-form-item__message" v-if="validateState === 'error' && showError('message')" :style="{
...
<script>
	 ...
	 * @property {String Number} label-width 提示文字的宽度，单位px（默认90）
