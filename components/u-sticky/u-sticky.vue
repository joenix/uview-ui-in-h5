<template>
	<div class="">
		<div class="u-sticky-wrap" :class="[elClass]" :style="{
			height: fixed ? height + 'px' : 'auto',
			backgroundColor: bgColor
		}">
			<div class="u-sticky" :style="{
...
<script>
	 ...
	 * @property {String Number} offset-top 吸顶时与顶部的距离，单位px（默认0）
	 ...
	 * @example <u-sticky offset-top="200"><div>塞下秋来风景异，衡阳雁去无留意</div></u-sticky>
	 */
	export default {
		name: "u-sticky",
		props: {
