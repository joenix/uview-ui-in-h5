<template>
	<div class="u-rate" :id="elId" @touchmove.stop.prevent="touchMove">
		<div class="u-star-wrap" v-for="(item, index) in count" :key="index" :class="[elClass]">
			<u-icon
 ...
 * @property {String Number} size 星星的大小，单位px（默认32）
