<template>
	<div class="u-radio" :style="[radioStyle]">
		<div class="u-radio__icon-wrap" @tap="toggle" :class="[iconClass]" :style="[iconStyle]">
			<u-icon
		...
		<div class="u-radio__label" @tap="onClickLabel" :style="{
...
<script>
	 ...
	 * @property {String Number} icon-size 图标大小，单位px（默认24）
