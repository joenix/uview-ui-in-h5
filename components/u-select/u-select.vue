<template>
	<div class="u-select">
		<!-- <div class="u-select__action" :class="{
			'u-select--border': border
		}" @tap.stop="selectHandler">
			<div class="u-select__action__icon" :class="{
		...
		<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<div class="u-select">
				<div class="u-select__header" @touchmove.stop.prevent="">
					<div
					...
					<div class="u-select__header__title">
						{{title}}
					</div>
					<div
				...
				<div class="u-select__body">
					<picker-view @change="columnChange" class="u-select__body__picker-view" :value="defaultSelector" @pickstart="pickstart" @pickend="pickend">
						<picker-view-column v-for="(item, index) in columnData" :key="index">
							<div class="u-select__body__picker-view__item" v-for="(item1, index1) in item" :key="index1">
								<div class="u-line-1">{{ item1[labelName] }}</div>
							</div>
						</picker-view-column>
					</picker-view>
				</div>
