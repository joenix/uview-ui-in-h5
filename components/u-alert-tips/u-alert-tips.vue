<template>
  ...
  >
    ...
    <div class="u-alert-content" @tap.stop="click">
      <div class="u-alert-title" :style="[uTitleStyle]">
        {{ title }}
      </div>
      <div v-if="description" class="u-alert-desc" :style="[descStyle]">
        {{ description }}
      </div>
    </div>
    <div class="u-icon-wrap">
