<template>
	<div class="u-slider" @tap="onClick" :class="[disabled ? 'u-slider--disabled' : '']" :style="{
		...
		>
			<div class="u-slider__button-wrap" @touchstart="onTouchStart" 
				@touchmove="onTouchMove" @touchend="onTouchEnd" 
				@touchcancel="onTouchEnd">
				<slot v-if="$slots.default  || $slots.$default"/>
				<div v-else class="u-slider__button" :style="[blockStyle, {
 ...
 * @property {Number | String} height 滑块条高度，单位px（默认6）
