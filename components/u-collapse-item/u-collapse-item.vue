<template>
	<div class="u-collapse-item" :style="[itemStyle]">
		<div :hover-stay-time="200" class="u-collapse-head" @tap.stop="headClick" :hover-class="hoverClass" :style="[headStyle]">
			<block v-if="!$slots['title-all']">
				<div v-if="!$slots['title']" class="u-collapse-title u-line-1" :style="[{ textAlign: align ? align : 'left' },
		...
		<div class="u-collapse-body" :style="[{
				height: isShow ? height + 'px' : '0'
			}]">
			<div class="u-collapse-content" :id="elId" :style="[bodyStyle]">
				<slot></slot>
			</div>
		</div>
	</div>
