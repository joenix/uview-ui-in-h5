<template>
	<div class="u-time-axis-item">
		<slot name="content" />
		<div class="u-time-axis-node" :style="[nodeStyle]">
			<slot name="node">
				<div class="u-dot">
				</div>
			</slot>
...
<script>
	 ...
	 * @property {String Number} node-top 节点左边图标绝对定位的top值，单位px
	...
	export default {
		...
		computed: {
			nodeStyle() {
				...
				if (this.nodeTop != "") style.top = this.nodeTop + 'px';
				return style;
			}
		}
	}
