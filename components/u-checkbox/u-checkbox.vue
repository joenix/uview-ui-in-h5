<template>
	<div class="u-checkbox" :style="[checkboxStyle]">
		<div class="u-checkbox__icon-wrap" @tap="toggle" :class="[iconClass]" :style="[iconStyle]">
			<u-icon class="u-checkbox__icon-wrap__icon" name="checkbox-mark" :size="checkboxIconSize" :color="iconColor"/>
		</div>
		<div class="u-checkbox__label" @tap="onClickLabel" :style="{
...
<script>
	 ...
	 * @property {String Number} icon-size 图标大小，单位px（默认20）
