	...
	<div class="u-keyboard" @touchmove.stop.prevent="() => {}">
		<div class="u-keyboard-grids">
			<div
				...
				<div class="u-keyboard-grids-btn">{{ item }}</div>
			</div>
			<div class="u-keyboard-grids-item u-bg-gray" hover-class="u-hover-class" :hover-stay-time="100" @touchstart.stop="backspaceClick"
			    @touchend="clearTimer">
				<div class="u-keyboard-back u-keyboard-grids-btn">
